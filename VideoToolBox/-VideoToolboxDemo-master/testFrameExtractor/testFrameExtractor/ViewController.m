...
//    self.video = [[SuperVideoFrameExtractor alloc] initWithVideo:[Utilities bundlePath:@"1080p30FPS.mp4"]];
    NSString *path = @"rtmp://live.hkstv.hk.lxdns.com/live/hks"; //@"rtsp://192.168.2.73:1935/vod/sample.mp4"
    self.video = [[SuperVideoFrameExtractor alloc] initWithVideo:path usesTcp:NO];
